...
```luau
loadstring(game:HttpGet("https://raw.githubusercontent.com/6nt0n/AssumVape-V4/main/NewMainScript.lua", true))()
```
...
2. Making sure you have connection to [the main loadstring.](https://raw.githubusercontent.com/6nt0n/AssumVape-V4/main/NewMainScript.lua)
3. Ensuring no external script is conflicting with vape.

## Developers & Credits
AssumVape V4 - community fork / independent distribution
<br/>
